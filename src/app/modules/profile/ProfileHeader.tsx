            ...
            <div className="card mb-5 mb-xl-8">
              <div className="card-body pt-15">
                ...
                <div className="d-flex flex-stack fs-4 py-3">
                  ...
                  {profileData?.data.isActive !== true ? <div className="badge badge-light-info d-inline">Inactive User</div> : <div className="badge badge-info d-inline">Active User</div>}
                  {profileData?.data.premium !== 'none' ? <div className="badge badge-info d-inline">Premium User</div> : null}
                </div>
                      ...
                      <div className="card-body pt-0">
                        <div className="fw-bolder fs-2">
                          <div className="d-flex">
                            ...
                            <div className="ms-2"> {profileData?.records.count} <span className="text-muted fs-4 fw-bold">Records Posted</span></div>
                          </div>
                      ...
                      <div className="card-body pt-0">
                        <div className="fw-bolder fs-2">
                          <div className="d-flex">
                            ...
                            <div className="ms-2"> {profileData?.listens.count} <span className="text-muted fs-4 fw-bold">Play</span></div>
                          </div>
                          <div className="fs-7 fw-normal text-muted">Earn reward points with every vocals.</div>
                        </div>
                      </div>

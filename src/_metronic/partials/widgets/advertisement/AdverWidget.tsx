...
const AdverWidget: React.FC<Props> = ({className}) => {
  return (
        ...
        <div className="card-body pt-5">
          ...
          ></div> */}
            <form id="kt_ecommerce_settings_general_form" className="form" action="#">
              ...
              <div className="row row-cols-2 row-cols-sm-2 rol-cols-md-2 row-cols-lg-4">
                <div className='col'>
                  <div className="fv-row mb-7">
                    <label className="fs-6 fw-bold form-label mt-3">
                      <span className="required">Times</span>
                      <i className="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter the times of ads to users."></i>
                    </label>
                    <input type="text" className="form-control form-control-solid" name="name" value="50000" />
                  </div>
                </div>
                <div className='col'>
                  <div className="fv-row mb-7">
                ...
                <div className='col'>
                  <div className="fv-row mb-7">
                    <label className="fs-6 fw-bold form-label mt-3">
                      <span>From</span>
                      <i className="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter start of Age."></i>
                    </label>
                    <input type="text" className="form-control form-control-solid" name="age" value="13" />
                  </div>
                </div>
                <div className='col'>
                  <div className="fv-row mb-7">
                    <label className="fs-6 fw-bold form-label mt-3">
                      <span>To</span>
                      <i className="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter end of Age."></i>
                    </label>
                    <input type="text" className="form-control form-control-solid" name="age" value="20" />
                  </div>
                </div>
              </div>
              <div className="row row-cols-2 row-cols-sm-2 rol-cols-md-2 row-cols-lg-4">
                  ...
                  <div className="fv-row mb-7">
                    ...
                    <div className="w-100">
                      <div className="form-floating border rounded">
                        <select id="kt_ecommerce_select2_country" className="form-select form-select-solid lh-1 py-3" name="country" data-kt-ecommerce-settings-type="select2_flags" data-placeholder="Select a country">
                          <option></option>
                ...
                <div className='col'>
                  <div className="fv-row mb-7">
                    <label className="fs-6 fw-bold form-label mt-3">
                      <span>Interests</span>
                      <i className="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter interests in App"></i>
                    </label>
                    <input type="text" className="form-control form-control-solid" name="interest" />
                  </div>
                </div>
                <div className='col'>
                  <div className="fv-row mb-7">
                    ...
                    <input type="text" className="form-control form-control-solid" name="duration" />
                  </div>
                </div>
              </div>
